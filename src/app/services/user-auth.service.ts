...
export class UserAuthService {
  ...
  changeUserEmail(newemail: string){
    ...
    this.http.post<{ message: string }>(BACKEND_URL + "/modifyemail", {email: newemail}).subscribe(
      () => {
  ...
  changeUserPassword(newpassword: string){
    ...
    this.http.post<{ message: string }>(BACKEND_URL + "/modifypassword", {password: newpassword}).subscribe(
      () => {
  ...
  checkIfUserLoggedIn(){
    ...
    this.http.get<{message: string}>(BACKEND_URL + "/checkloggedin").subscribe(
      response => {
        // this is 
        console.log(response.message);
        this.authStatusListener.next("success");
